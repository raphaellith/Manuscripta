...
public class ReadingMaterialEntity : MaterialEntity
{
    ...
    public ReadingMaterialEntity(Guid id, Guid lessonId, string title, string content, DateTime? timestamp = null, string? metadata = null, JsonArray? vocabularyTerms = null, int? readingAge = null, int? actualAge = null, LinePatternType? linePatternType = null, LineSpacingPreset? lineSpacingPreset = null, FontSizePreset? fontSizePreset = null)
        : base(id, lessonId, title, content, MaterialType.READING, timestamp, metadata, vocabularyTerms, readingAge, actualAge, linePatternType, lineSpacingPreset, fontSizePreset)
    {
    }
}
