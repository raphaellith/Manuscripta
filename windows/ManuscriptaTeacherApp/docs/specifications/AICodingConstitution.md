...
- `NetworkingSpec.md`, the specification that defines the Windows application's networking specifications, which describe the bidirectional communication between its Electron front end and its ASP.NET Core back end.