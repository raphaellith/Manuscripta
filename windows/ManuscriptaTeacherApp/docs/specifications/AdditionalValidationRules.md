...
## Section 3C - Paired Device

(1) A paired device is represented by a `PairedDeviceEntity` class. This class must contain the following attributes.

    (a) `DeviceId` (UUID): The unique identifier of the device, generated by the Android client per Validation Rules s3(4).

    (b) `Name` (string): The user-friendly device name, as provided during pairing per Pairing Process Specification s2(2)(c).
