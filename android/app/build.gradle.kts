...
android {
    ...
    signingConfigs {
        create("release") {
            storeFile = file("${System.getProperty("user.home")}/manuscripta-release.jks")
            storePassword = System.getenv("KEYSTORE_PASSWORD") ?: ""
            keyAlias = "manuscripta-key"
...
tasks.register<JacocoReport>("jacocoTestReport") {
    ...
    val debugTree = fileTree(javaClassesDir) {
        ...
        exclude("**/R.class",
            ...
            "**/ui/feedback/FeedbackFragment$*.class",
            "**/ui/feedback/TeacherFeedbackFragment.class",
            "**/ui/feedback/TeacherFeedbackFragment$*.class",
            "**/ui/renderer/MarkdownRenderer.class",
            "**/ui/renderer/MarkdownRenderer$*.class",
            "**/ui/renderer/QuestionBlockRenderer.class",
            "**/ui/renderer/QuestionBlockRenderer$*.class",
            "**/ui/renderer/AttachmentImageLoader.class",
            "**/ui/renderer/AttachmentImageLoader$*.class",
            "**/ui/view/*View.class",
            "**/ui/view/*View$*.class",
            "**/R$*.class",
