...
/**
 * Mapper class to convert between ResponseEntity (data layer), Response (domain layer),
 * and ResponseDto (network layer).
 * Provides bidirectional mapping for Clean Architecture separation.
 *
 * <p>Important: Response IDs are generated by Android and preserved by Windows
 * (API Contract §4.1).</p>
 *
