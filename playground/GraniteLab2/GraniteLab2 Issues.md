...
**Tasks:**
- [ ] **Filters:** Dropdown to select a specific `Experiment ID`.
- [ ] **Data Processing:** Load results from SQLite into a Pandas DataFrame.
- [ ] **Visuals (Plotly):**
    - [ ] Bar Chart: Average TPS per Model.
    - [ ] Bar Chart: Average Latency per Model.
- [ ] **Pivot Table:** Render a comprehensive table where Rows=Prompts, Cols=Models, Cell=Output.
- [ ] **Drill-Down:** Make table cells clickable to view the full metadata (System prompt used, specific duration, full output text).